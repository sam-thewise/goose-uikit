...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#1c034e", textDisabled: "#BDC2C4", textSubtle: "#efcd52", borderColor: "#E9EAEB", card: "rgba(0,0,0,0.5)", gradients: {
