...
var LogoImage = styled__default['default'].div(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  margin-left: 24px;\n"], ["\n  margin-left: 24px;\n"])));
var Logo = function (_a) {
    _a.isDark; __rest(_a, ["isDark"]);
    return (React__default['default'].createElement(LogoImage, null,
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React__default['default'].createElement(Flex, { mb: "32px" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://cchain.explorer.avax.network/" + account, mr: "16px" }, "View on Explorer"),
...
var MenuIconDiv = styled__default['default'].div(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  text-align: left;\n  display: grid;\n  grid-template-columns: 50px 1fr;\n  align-items: center;\n  width: 50%;\n\n  @media (max-width: 820px) {\n    .menu-text {\n      display : none;\n      margin-left: 10%;\n  }\n\n  @media (max-width: 540px) {\n    .menu-icons {\n      display : contents;\n    }\n  }\n"], ["\n  text-align: left;\n  display: grid;\n  grid-template-columns: 50px 1fr;\n  align-items: center;\n  width: 50%;\n\n  @media (max-width: 820px) {\n    .menu-text {\n      display : none;\n      margin-left: 10%;\n  }\n\n  @media (max-width: 540px) {\n    .menu-icons {\n      display : contents;\n    }\n  }\n"])));
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        ...
        React__default['default'].createElement(MenuWrapper, null,
            React__default['default'].createElement(StyledLinkTag, { href: "https://t.me/thedragonslairfarm", target: "_blank" },
                React__default['default'].createElement(MenuIconDiv, { className: "menu-icons" },
                    React__default['default'].createElement("img", { alt: "telegram", src: "https://image.flaticon.com/icons/png/512/124/124019.png" }),
                    " ",
                    React__default['default'].createElement("span", { className: "menu-text" }, "TELEGRAM"))),
            React__default['default'].createElement(StyledLinkTag, { href: "https://twitter.com/DRGNCRYPTOGAMIN", target: "_blank" },
                React__default['default'].createElement(MenuIconDiv, { className: "menu-icons" },
                    React__default['default'].createElement("img", { alt: "twitter", src: "https://seeklogo.com/images/T/twitter-icon-square-logo-108D17D373-seeklogo.com.png" }),
                    " ",
                    React__default['default'].createElement("span", { className: "menu-text" }, "TWITTER"))),
            React__default['default'].createElement(StyledLinkTag, { href: "https://docs.thedragonslair.farm/", target: "_blank" },
                React__default['default'].createElement(MenuIconDiv, { className: "menu-icons" },
                    React__default['default'].createElement("img", { alt: "docs", src: "https://cdn2.iconfinder.com/data/icons/metro-ui-dock/512/Doc_-_Google_Docs.png" }),
                    " ",
                    React__default['default'].createElement("span", { className: "menu-text" }, "DOCS"))),
            React__default['default'].createElement(StyledLinkTag, { href: "https://chartex.pro/?symbol=AVAX_TRADERJOE%3ADREGG%2FUSDTe.0xB52a2b91Bf89BcB9435ad94D23555EaD26954CA9", target: "_blank" },
                React__default['default'].createElement(MenuIconDiv, { className: "menu-icons" },
                    React__default['default'].createElement("img", { alt: "charts", src: "https://d1nhio0ox7pgb.cloudfront.net/_img/o_collection_png/green_dark_grey/512x512/plain/chart_candlestick.png" }),
                    React__default['default'].createElement("span", { className: "menu-text" }, "CHART"))),
            React__default['default'].createElement(StyledLinkTag, { href: "https://www.traderjoexyz.com/#/trade?outputCurrency=0x88c090496125b751B4E3ce4d3FDB8E47DD079c57", target: "_blank" },
                React__default['default'].createElement(MenuIconDiv, { className: "menu-icons" },
                    React__default['default'].createElement("img", { alt: "exchange", src: "/images/menu/tjoe.png" }),
                    React__default['default'].createElement("span", { className: "menu-text" }, "EXCHANGE"))))));
};
var templateObject_1$H, templateObject_2$f, templateObject_3$8, templateObject_4$3, templateObject_5$1, templateObject_6, templateObject_7, templateObject_8, templateObject_9, templateObject_10, templateObject_11, templateObject_12;
